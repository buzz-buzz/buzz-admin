    ...
    render() {
        ...
        return (
            <Modal open={this.props.open} closeOnEscape={true}
                   closeOnRootNodeClick={true} onClose={this.close}>
                ...
                <Modal.Content>
                    ...
                    <Form error={this.state.error} loading={this.state.loading}>
                        ...
                        <Form.Group>
                            <Form.Input placeholder="积分" name="charge"
                                        value={charge}
                                        onChange={this.handleChange}
                                        type="number"/>
                            <Form.Button content="增加" type="button"
                                         onClick={this.charge}/>
                        </Form.Group>
                        <Form.Group>
                            <Form.Input placeholder="积分" name="consume"
                                        value={consume}
                                        onChange={this.handleChange}
                                        type="number"/>
                            <Form.Button content="扣除" type="button"
